...
import { GetSubscriptionUseCase } from '@promptdeploy/core';
...
export function makeGetSubscriptionHandler(
  subscriptionRepo: SubscriptionRepository,
) {
  const useCase = new GetSubscriptionUseCase(subscriptionRepo);
